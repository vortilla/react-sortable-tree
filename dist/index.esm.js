...
var _excluded = ["scaffoldBlockPxWidth", "toggleChildrenVisibility", "connectDragPreview", "connectDragSource", "isDragging", "canDrop", "canDrag", "node", "title", "subtitle", "draggedNode", "path", "treeIndex", "isSearchMatch", "isSearchFocus", "buttons", "className", "style", "didDrop", "treeId", "isOver", "parentNode", "rowDirection"];
...
var _excluded$1 = ["children", "listIndex", "swapFrom", "swapLength", "swapDepth", "scaffoldBlockPxWidth", "lowerSiblingCounts", "connectDropTarget", "isOver", "draggedNode", "canDrop", "treeIndex", "treeId", "getPrevRow", "node", "path", "rowDirection"];
...
var _excluded$2 = ["children", "connectDropTarget", "treeId", "drop"];
...
var ReactSortableTree = /*#__PURE__*/function (_Component) {
  ...
  function ReactSortableTree(props) {
    ...
    _this.dndManager = new DndManager(_assertThisInitialized(_this));
  ...
  _createClass(ReactSortableTree, [{
    ...
    value: function renderRow(row, rowRenderer, nodeRender) {
      ...
      var Renderers = /*#__PURE__*/React.createElement(TreeNodeRenderer, _extends({
        style: style,
        key: nodeKey,
        listIndex: listIndex,
      ...
      return /*#__PURE__*/React.createElement(React.Fragment, null, this.isDynamicRowHeight ? /*#__PURE__*/React.createElement(CellMeasurer, {
        key: key,
        cache: this.cellMeasureCache,
        parent: parent,
        columnIndex: 0,
        rowIndex: index
      }, Renderers) : /*#__PURE__*/React.createElement(React.Fragment, null, Renderers));
    }
  }, {
    key: "render",
    value: function render() {
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      ...
      var newState = {};
      var isTreeDataEqual = isEqual(instanceProps.treeData, nextProps.treeData);
...
var SortableTreeWithoutDndContext = /*#__PURE__*/forwardRef(function (props, ref) {
  return /*#__PURE__*/React.createElement(DndContext.Consumer, null, function (_ref16) {
